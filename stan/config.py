...
TOP_NASDAQ: list[str] = [
    ...
    "COST", "NFLX", "QCOM", "AMD",  "CSCO", "INTC", "CMCSA", "TXN",
    "INTU", "AMAT", "MU",   "ADI",  "KLAC", "LRCX", "MCHP", "CDNS",
    "SNPS", "NXPI", "WDAY", "ROST", "PAYX", "FAST", "BIIB", "IDXX",
    "DLTR", "PCAR", "VRSK", "ANSS", "TTWO", "PANW", "CRWD", "DDOG",
    "FTNT", "SBUX", "PYPL", "GILD", "AMGN", "REGN", "VRTX", "ISRG",
    "ILMN", "ZS",
]

TOP_NYSE: list[str] = [
    "BRK-B", "LLY",  "JPM",  "V",    "UNH",  "XOM",  "MA",   "PG",
    "JNJ",   "HD",   "CVX",  "MRK",  "ABBV", "KO",   "BAC",  "PEP",
    "WMT",   "TMO",  "ABT",  "ACN",  "MCD",  "PM",   "IBM",  "GE",
    "HON",   "RTX",  "CAT",  "UPS",  "BA",   "GS",   "MS",   "BLK",
    "SPGI",  "AXP",  "C",    "WFC",  "MCO",  "COF",  "CRM",  "ORCL",
    "NOW",   "UBER", "T",    "VZ",   "NEE",  "DUK",  "SO",   "MMM",
    "DE",    "SHW",
]
